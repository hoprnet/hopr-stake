...
(whitehatTestOnly ? describe.skip : describe)('HoprStakeSeason4', function () {
    let deployer: Signer;
    let admin: Signer;
    ...
    describe('After PROGRAM_S4_END', function () {
        ...
        it('succeeds in advancing block to PROGRAM_S4_END + 1', async function () {
            await advanceTimeForNextBlock(PROGRAM_S4_END + 1);
